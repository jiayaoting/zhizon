...
│       │   │   ├── pages/     # 15 pages: AppShell, Index, Games, Chat, Profile, Settings, ChatConfig, GameHistory, LegalDoc, Tetris, Game2048, Snake, Minesweeper, Sudoku, ChineseChess
│       │   │   └── service/   # 14 files: DatabaseHelper, DataRepository, ChatRepository, LlmClient, GameAIService, ChineseChessEngine, SecurityService, BiometricHelper, BackgroundImporter, SudokuSolver, PickerAdapter, WindowEnvironmentProvider
...
|------|-------|-------------|
| ArkTS source | 55 | 1 entryability + 11 common + 2 model + 14 service + 12 components + 15 pages |
